...
@click.option('-wg','--work_group',required=True, prompt=True, type=str, help="verid group to be converted to runner format")
...
def createjob(work_group):
    ...
    for idx,workchain in enumerate(all_works): #print(idx,workchain.out)
